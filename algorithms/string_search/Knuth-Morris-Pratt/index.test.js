import KnuthMorrisPrattSearchString from './index';

describe('Knuth-Morris-Pratt search string', () => {
  ...
  test('should return string is empty', () => {
    const received = KnuthMorrisPrattSearchString(
  ...
  test('middle substring should return 4', () => {
    const received = KnuthMorrisPrattSearchString(
      testStringList.string,
      testSubStringList.midSubString,
    );
  ...
  test('end substring should return 8', () => {
    const received = KnuthMorrisPrattSearchString(
      testStringList.string,
      testSubStringList.endSubString,
    );
