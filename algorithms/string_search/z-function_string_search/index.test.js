import zFunctionSearchString from './index';

describe('z-function search string', () => {
  ...
  test('should return string is empty', () => {
    const received = zFunctionSearchString(
  ...
  test('should return substring is empty', () => {
    const received = zFunctionSearchString(testStringList.string, testSubStringList.emptySubString);
    const expected = resultList.subempty;
    expect(received).toEqual(expected);
  });
  test('begin substring should return 0', () => {
    const received = zFunctionSearchString(testStringList.string, testSubStringList.beginSubString);
    const expected = resultList.beginSubString;
    expect(received).toEqual(expected);
  });
  test('middle substring should return 4', () => {
    const received = zFunctionSearchString(testStringList.string, testSubStringList.midSubString);
    const expected = resultList.midSubString;
    expect(received).toEqual(expected);
  });
  test('end substring should return 8', () => {
    const received = zFunctionSearchString(testStringList.string, testSubStringList.endSubString);
